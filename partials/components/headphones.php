...
<html lang="en">
  ...
  <div style="background: linear-gradient(135deg, #f403d1, #64b5f6);" class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4 text-white"><b>Select The Headphones</b></h1>
        <p class="lead text-white"><b>Tip: Use 'over the ear' type for optimal comfort.</b></p>
      </div>
    </div>
    ...
    <table class="table my-5" id="myTable">
        <thead>
            ...
            <th scope="col">Enclosure type</th>
